...
class _AdminEventPageState extends State<AdminEventPage> {
  ...
  void initState() {
    ...
    var currentUser = ref.child('Users').child(globalUserId).child('Event_Admin');
          ...
          child: allData.length == 0
            ...
            itemBuilder: (_, index) {
              ...
              return UI(
                ...
                allData[index].LocationName,allData[index].EventID,allData[index].AdminID, allData[index].lat, allData[index].lon
              );
            },
          )
      ),
  ...
  Widget UI(var name, var StartingDate, var FinishingDate, var StartingTime,
      var FinishingTime, var Accessability,var LocationName, var j , var eventAdmin, var lat, var lon) {
          ...
          children: [
            ...
            new FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.push(context, MaterialPageRoute(
                  builder: (context) => EventInfoPage(j, name, sDate, fDate, allData[j].StartingTime,
                      allData[j].FinishingTime, Accessability, lat, lon),
                ));
              },
